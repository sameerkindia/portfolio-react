    ...
    <>
      <section className="hero-page">
        ...
        <div className="hero-content">
          <h3 className="main-sub-heading">Hello , I Am Sameer</h3>
          <h1 className="heading">A Passionate MERN Stack Developer</h1>
          ...
          <div className="hero-btn-box">
            <Button path="/contect">contect now</Button>
            <Button path="/project">view project</Button>
          </div>
        </div>
      </section>
      <section className="about-me">
        ...
        <div className="about-me-content">
          ...
          .
          <p>
            My proficiency extends to HTML5 and CSS, and I add a touch of
            elegance with Tailwind CSS for streamlined styling. In the world of
            databases, MongoDB is my go-to for efficient and scalable data
            management. With a solid understanding of state management using
            Redux and a commitment to writing clean, modern JavaScript (ES6+), I
            ensure that each line of code contributes to the success of the
            project.
          </p>
          <p>
